...
// create gameInfo which includes time and flipscount.
const gameInfo = document.createElement('div');
gameInfoContainer.appendChild(gameInfo);

gameInfo.classList.add('game-info');
// add time in the gameinfo container.
gameInfo.innerText = 'Time'; 
...
// create flipscount which includes flipcounts.
const gameInfo1 = document.createElement('div');
...
cardGenerator(2);
// cardGenerator function which generates the cards in the gameContainer.
function cardGenerator(series_value) {
...
radioBtn.forEach(current_elem => {
    current_elem.addEventListener('click', () => {
        clearInterval(timer);
        totalClicks = 0;
        console.log('current_elem.checked', current_elem.checked);
